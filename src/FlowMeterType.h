...
struct MeterFlowType {
     ...
     */
    MeterFlowType(const std::string& _nameWaterMeter, unsigned _nominalDiameter, double _nominalFlow,
                  double _maximumFlow, double _trasitionFlow, double _minimumFlow, double _nominalError,
                  double _maximumError)
        : nameWaterMeter(_nameWaterMeter), nominalDiameter(_nominalDiameter), nominalFlow(_nominalFlow),
          maximumFlow(_maximumFlow), transitionFlow(_trasitionFlow), minimumFlow(_minimumFlow),
          nominalError(_nominalError), maximumError(_maximumError) {}
     ...
     */
    MeterFlowType()
        : nameWaterMeter(""), nominalDiameter(0), nominalFlow(0), maximumFlow(0), transitionFlow(0), minimumFlow(0),
          nominalError(0), maximumError(0) {}
};
...
inline const std::vector<MeterFlowType>& getDefaultTypes() {
    static const std::vector<MeterFlowType> defaults = {
        ...
        // Itron Flodis Series
        MeterFlowType( "Itron Flodis DN 15",                15,      1500,     3000,       22.50,     15.00,      2,      5 ),
        MeterFlowType( "Itron Flodis DN 20",                20,      2500,     5000,       37.50,     25.00,      2,      5 ),
        MeterFlowType( "Itron Flodis DN 25",                25,      3500,     7000,       52.50,     35.00,      2,      5 ),

        // Itron Flostar Series
        MeterFlowType( "Itron Flostar DN 40",               40,     16000,    20000,      160.00,     80.00,      2,      5 ),
        MeterFlowType( "Itron Flostar DN 50",               50,     25000,    31250,      127.00,     79.00,      2,      5 ),
        MeterFlowType( "Itron Flostar DN 65",               65,     40000,    50000,      160.00,    100.00,      2,      5 ),
        MeterFlowType( "Itron Flostar DN 80",               80,     63000,    78000,      252.00,    157.00,      2,      5 ),
        MeterFlowType( "Itron Flostar DN 100",             100,    100000,   125000,      400.00,    250.00,      2,      5 ),
        MeterFlowType( "Itron Flostar DN 150",             150,    160000,   200000,      406.00,    254.00,      2,      5 ),

        // FGH Sentinel 420 PC Series
        MeterFlowType( "FGH Sentinel 420 PC DN 15 R80",     15,      2500,     3125,       50.00,     31.25,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 15 R160",    15,      2500,     3125,       25.00,     15.63,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 20 R80",     20,      4000,     5000,      100.00,     62.50,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 20 R160",    20,      4000,     5000,       40.00,     25.00,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 25 R80",     25,      6300,     7875,      126.00,     78.75,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 25 R160",    25,      6300,     7875,       63.00,     39.40,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 25 R80",     25,      8000,    10000,      160.00,    100.00,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 25 R160",    25,      8000,    10000,       80.64,     50.40,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 32 R80",     32,     10000,    12000,      200.00,    125.00,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 32 R160",    32,     10000,    12000,      100.00,     62.50,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 40 R80",     40,     16000,    20000,      320.00,    200.00,      2,      5 ),
        MeterFlowType( "FGH Sentinel 420 PC DN 40 R160",    40,     16000,    20000,      160.00,    100.00,      2,      5 ),

        // FGH MeiStream Plus Series
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 40",    40,     30000,    50000,      130.00,     80.00,      2,      5 ),
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 50",    50,     35000,    55000,      130.00,     70.00,      2,      5 ),
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 65",    65,     40000,    60000,      160.00,    100.00,      2,      5 ),
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 80",    80,     63000,   120000,      250.00,    130.00,      2,      5 ),
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 100",  100,    100000,   160000,      400.00,    200.00,      2,      5 ),
        MeterFlowType( "FGH MeiStream Plus Cl. C DN 150",  150,    250000,   400000,      630.00,    350.00,      2,      5 ),

        // FGH iPERL R800 Series
        MeterFlowType( "FGH iPERL R800 DN 15",              15,      2500,     3125,        5.00,      3.13,      2,      5 ),
        MeterFlowType( "FGH iPERL R800 DN 20",              20,      4000,     5000,        8.00,      5.00,      2,      5 ),
        MeterFlowType( "FGH iPERL R800 DN 25",              25,      6300,     7875,       12.60,      7.88,      2,      5 ),
        MeterFlowType( "FGH iPERL R800 DN 30",              30,     10000,    12500,       20.00,     12.50,      2,      5 ),
        MeterFlowType( "FGH iPERL R800 DN 40",              40,     16000,    20000,       32.00,     20.00,      2,      5 ),

        // FGH MNK Series
        MeterFlowType( "FGH MNK DN 15 R80",                 15,      2500,     3125,       50.00,     31.25,      2,      5 ),
        MeterFlowType( "FGH MNK DN 15 R160",                15,      2500,     3125,       25.00,     15.63,      2,      5 ),
        MeterFlowType( "FGH MNK DN 20 R80",                 20,      4000,     5000,      100.00,     62.50,      2,      5 ),
        MeterFlowType( "FGH MNK DN 20 R160",                20,      4000,     5000,       40.00,     25.00,      2,      5 ),
        MeterFlowType( "FGH MNK DN 25 R80",                 25,      6300,     7875,      126.00,     78.75,      2,      5 ),
        MeterFlowType( "FGH MNK DN 25 A",                   25,      6300,     7875,       63.00,     39.40,      2,      5 ),
        MeterFlowType( "FGH MNK DN 25 B",                   25,      8000,    10000,      160.00,    100.00,      2,      5 ),
        MeterFlowType( "FGH MNK DN 25 C",                   25,      8000,    10000,       80.64,     50.40,      2,      5 ),
        MeterFlowType( "FGH MNK DN 32 R80",                 32,     10000,    12000,      200.00,    125.00,      2,      5 ),
        MeterFlowType( "FGH MNK DN 32 R160",                32,     10000,    12000,      100.00,     62.50,      2,      5 ),
        MeterFlowType( "FGH MNK DN 40 R80",                 40,     16000,    20000,      320.00,    200.00,      2,      5 ),
        MeterFlowType( "FGH MNK DN 40 R160",                40,     16000,    20000,      160.00,    100.00,      2,      5 ),
        MeterFlowType( "FGH MNK DN 50 R80",                 50,     25000,    31250,      500.00,    312.50,      2,      5 ),
        MeterFlowType( "FGH MNK DN 50 R255",                50,     25000,    31250,      160.00,    100.00,      2,      5 )
    };
    return defaults;
}
...
inline std::vector<MeterFlowType> readFlowMeterTypesCSV(const std::string& filename) {
    ...
    if (!file.is_open()) {
        ...
        warningMessage.setInformativeText(QObject::tr("The watermeters.csv with Flow Meters DB cannot be found."));
    ...
    try {
        ...
        warningMessage.setWindowTitle(QObject::tr("Warning"));
        warningMessage.setText(QObject::tr("Flow Meters DB"));
        warningMessage.setInformativeText(QObject::tr("The watermeters.csv with Flow Meters DB is corrupted."));
        warningMessage.setWindowFlags(Qt::Dialog | Qt::CustomizeWindowHint | Qt::WindowTitleHint |
                                      Qt::WindowCloseButtonHint);
        warningMessage.exec();
        return std::vector<MeterFlowType>(FlowMeterDB::getDefaultTypes().begin(),
