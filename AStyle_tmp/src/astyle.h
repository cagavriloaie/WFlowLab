...
//-----------------------------------------------------------------------------
    ...
    {
      public:
        void buildAssignmentOperators(vector<const string *>
                                      *assignmentOperators);
        ...
        void buildIndentableMacros(
            vector<const pair<const string, const string>* > *indentableMacros);
        void buildIndentableHeaders(vector<const string *>
                                    *indentableHeaders);
        void buildNonAssignmentOperators(vector<const string *>
        ...
        void buildPreBlockStatements(vector<const string *>
                                     *preBlockStatements, int fileType);
        void buildPreCommandHeaders(vector<const string *> *preCommandHeaders,
                                    int fileType);
        void buildPreDefinitionHeaders(vector<const string *>
                                       *preDefinitionHeaders, int fileType);
      ...
      public:
        ...
        static const string AS_CLASS, AS_STRUCT, AS_UNION, AS_INTERFACE,
               AS_NAMESPACE;
        ...
        static const string AS_STATIC, AS_CONST, AS_SEALED, AS_VOLATILE,
               AS_NEW, AS_DELETE;
        ...
        static const string AS_OPEN_LINE_COMMENT, AS_OPEN_COMMENT,
               AS_CLOSE_COMMENT;
        static const string AS_BAR_DEFINE, AS_BAR_INCLUDE, AS_BAR_IF,
               AS_BAR_EL, AS_BAR_ENDIF;
        ...
        static const string AS_GR_GR_ASSIGN, AS_LS_LS_ASSIGN,
               AS_GR_GR_GR_ASSIGN, AS_LS_LS_LS_ASSIGN;
        static const string AS_GCC_MIN_ASSIGN, AS_GCC_MAX_ASSIGN;
        static const string AS_EQUAL, AS_PLUS_PLUS, AS_MINUS_MINUS,
               AS_NOT_EQUAL, AS_GR_EQUAL;
        static const string AS_LS_EQUAL, AS_LS_LS_LS, AS_LS_LS, AS_GR_GR_GR,
               AS_GR_GR;
        ...
        static const string AS_PLUS, AS_MINUS, AS_MULT, AS_DIV, AS_MOD, AS_GR,
               AS_LS;
        static const string AS_NOT, AS_BIT_XOR, AS_BIT_OR, AS_BIT_AND,
               AS_BIT_NOT;
        ...
        static const string AS_CONST_CAST, AS_DYNAMIC_CAST,
               AS_REINTERPRET_CAST, AS_STATIC_CAST;
...
//-----------------------------------------------------------------------------
    ...
    class ASBase : protected ASResource
    {
      ...
      protected:  // functions definitions are at the end of ASResource.cpp
        ...
        bool findKeyword(const string &line, int i,
...
//-----------------------------------------------------------------------------
    ...
    class ASBeautifier : protected ASBase
    {
      ...
      protected:
        ...
        int  indexOf(const vector<const string *> &container,
      ...
      private:  // functions
        ...
        void adjustParsedLineIndentation(size_t iPrelim,
        ...
        void registerContinuationIndent(const string &line, int i,
                                        int spaceIndentCount_,
                                        int tabIncrementIn, int minIndent, bool updateParenStack);
        void registerContinuationIndentColon(const string &line, int i,
                                             int tabIncrementIn);
        void initVectors();
        void initTempStacksContainer(vector<vector<const string *>*>
                                     *&container,
        ...
        void deleteTempStacksContainer(vector<vector<const string *>*>
                                       *&container);
        int  adjustIndentCountForBreakElseIfComments() const;
        int  computeObjCColonAlignment(const string &line,
        ...
        int  getContinuationIndentAssign(const string &line,
                                         size_t currPos) const;
        int  getContinuationIndentComma(const string &line,
                                        size_t currPos) const;
        ...
        const string &getIndentedLineReturn(const string &newLine,
                                            const string &originalLine) const;
        ...
        vector<vector<const string *>*> *copyTempStacks(const ASBeautifier
                &other) const;
...
//-----------------------------------------------------------------------------
    ...
    class ASEnhancer : protected ASBase
    {
      public:  // functions
        ...
        void enhance(string &line, bool isInNamespace, bool isInPreprocessor,
                     bool isInSQL);
      ...
      private:  // functions
        ...
        bool   isBeginDeclareSectionSQL(const string  &line,
                                        size_t index) const;
        bool   isEndDeclareSectionSQL(const string  &line,
                                      size_t index) const;
        bool   isOneLineBlockReached(const string &line, int startChar) const;
        void   parseCurrentLine(string &line, bool isInPreprocessor,
                                bool isInSQL);
      ...
      private:
        ...
        vector<SwitchVariables>
        switchStack;     // stack vector of switch variables
...
//-----------------------------------------------------------------------------
    ...
    class ASFormatter : public ASBeautifier
    {
      ...
      private:  // functions
        ...
        bool isStructAccessModified(const string &firstLine,
                                    size_t index) const;
        bool isIndentablePreprocessorBlock(const string &firstLine,
                                           size_t index);
        bool isNDefPreprocStatement(const string &nextLine_,
        ...
        void initContainer(vector<BraceType> *&container,
        ...
        size_t findNextChar(const string &line, char searchChar,
                            int searchStart = 0) const;
        const string *checkForHeaderFollowingComment(const string &firstLine)
        const;
      ...
      private:  // variables
        ...
        vector<const pair<const string, const string>* >
        *indentableMacros; // for ASEnhancer
