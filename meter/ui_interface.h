...
public:
    ...
    void setupUi(QDialog *Interface)
    {
        ...
        Interface->resize(575, 670);
        Interface->setMinimumSize(QSize(575, 670));
        Interface->setMaximumSize(QSize(575, 670));
        QIcon icon;
        icon.addFile(QString::fromUtf8("WStreamLab.ico"), QSize(), QIcon::Normal, QIcon::Off);
        Interface->setWindowIcon(icon);
        Interface->setStyleSheet(QString::fromUtf8("QPushButton:hover {\n"
...
""));
        ...
        pbRefreshSerialPort->setFocusPolicy(Qt::NoFocus);
        pbRefreshSerialPort->setStyleSheet(QString::fromUtf8(" padding-left: 10px; \n"
" padding-top: 1px; \n"
" padding-right: 10px;\n"
" padding-down: 10px; "));
        ...
        pbTestConnection->setFocusPolicy(Qt::NoFocus);
        pbTestConnection->setStyleSheet(QString::fromUtf8(" padding-left: 10px; \n"
" padding-top: 1px; \n"
" padding-right: 10px;\n"
" padding-down: 10px; "));
        ...
        pbSaveConfiguration->setFocusPolicy(Qt::NoFocus);
        pbSaveConfiguration->setStyleSheet(QString::fromUtf8(" padding-left: 10px; \n"
" padding-top: 1px; \n"
" padding-right: 10px;\n"
" padding-down: 10px; "));
