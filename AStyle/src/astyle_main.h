...
// for mingw BOM, UTF-16, and Unicode functions
    ...
    typedef void (STDCALL *fpError)(int errorNumber,
...
//----------------------------------------------------------------------------
    ...
    class ASStreamIterator : public ASSourceIterator
    {
      ...
      private:
        ...
        ASStreamIterator &operator=(ASStreamIterator
                                    &);      // assignment operator not to be implemented
...
//----------------------------------------------------------------------------
    ...
    class ASOptions
    {
      public:
        ...
        bool parseOptions(vector<string> &optionsVector,
      ...
      private:
        ...
        // functions
        ASOptions(const ASOptions
                  &);          // copy constructor not to be implemented
        ASOptions &operator=(ASOptions
                             &);     // assignment operator not to be implemented
...
//----------------------------------------------------------------------------
    ...
    class ASConsole
    {
      private:    // variables
        ASFormatter
        &formatter;             // reference to the ASFormatter object
        ...
        vector<bool>
        excludeHitsVector;   // exclude flags for error reporting
        vector<string>
        ...
        vector<string>
        fileName;            // files to be processed including path
      ...
      private:    // functions
        ASConsole(const ASConsole
                  &);          // copy constructor not to be implemented
        ASConsole &operator=(ASConsole
                             &);     // assignment operator not to be implemented
        ...
        void getFileNames(const string &directory,
        ...
        FileEncoding readFile(const string &fileName_,
        ...
        void setOutputEOL(LineEndFormat lineEndFormat,
