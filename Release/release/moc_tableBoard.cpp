/****************************************************************************
** Meta object code from reading C++ file 'tableBoard.h'
**
...
#include <memory>
    ...
    #error "The header file 'tableBoard.h' doesn't include <QObject>."
...
namespace
{
    ...
    static constexpr auto qt_meta_stringdata_CLASSDialogENDCLASS =
...
#define QT_MOC_LITERAL(ofs, len) \
    ...
    Q_CONSTINIT static const qt_meta_stringdata_CLASSDialogENDCLASS_t
    qt_meta_stringdata_CLASSDialogENDCLASS =
    {
        {
            ...
            QT_MOC_LITERAL(242, 12),  // "focusInEvent"
            QT_MOC_LITERAL(255, 12),  // "QFocusEvent*"
            QT_MOC_LITERAL(268, 5),  // "event"
            QT_MOC_LITERAL(274, 13)   // "focusOutEvent"
        },
        "Dialog",
        "onTypeMeterChanged",
        "",
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c,
                                int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            ...
            case 4: _t->onCbClicked((*reinterpret_cast< std::add_pointer_t<bool>>
                                         (_a[1]))); break;
            ...
            case 11: _t->focusInEvent((
                                              *reinterpret_cast< std::add_pointer_t<QFocusEvent *>>(_a[1]))); break;
            case 12: _t->focusOutEvent((
                                               *reinterpret_cast< std::add_pointer_t<QFocusEvent *>>(_a[1]))); break;
            default: ;
        }
    }
...
void *Dialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname,
                qt_meta_stringdata_CLASSDialogENDCLASS.stringdata0))
    {
