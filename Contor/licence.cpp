...
void License::Translate() {
    this->setWindowTitle ( tr ( "WFlowLab - License" ) );
...
void License::showEvent ( QShowEvent *event ) {
    ...
    ui->lbCompanyValue->setText ( mainwindow->optionsConfiguration["company"].c_str() );
    ui->lbCertificateValue->setText ( mainwindow->optionsConfiguration["certificate"].c_str() );
    ui->lbArchiveValue->setText ( mainwindow->optionsConfiguration["archive"].c_str() );
    ui->lbMaximumValue->setText ( mainwindow->optionsConfiguration["maximum"].c_str() );
    ui->lbDensityValue->setText ( mainwindow->optionsConfiguration["density_20"].c_str() );
    ui->lbChecksumValue->setText ( mainwindow->optionsConfiguration["control"].c_str() );
}
