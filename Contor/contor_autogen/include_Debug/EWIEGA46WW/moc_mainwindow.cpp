...
void MainWindow::qt_static_metacall ( QObject *_o, QMetaObject::Call _c, int _id, void **_a ) {
    if ( _c == QMetaObject::InvokeMetaMethod ) {
        ...
        switch ( _id ) {
        case 0:
            _t->NumberOfWaterMetersChangedSignal();
            break;

        case 1:
            _t->meterTypeChangedSignal();
            break;

        case 2:
            _t->measurementTypeChangedSignal();
            break;

        case 3:
            _t->onMeterTypeChanged ( ( *reinterpret_cast< std::add_pointer_t<int>> ( _a[1] ) ) );
            break;

        case 4:
            _t->onNumberOfWaterMetersChanged ( ( *reinterpret_cast< std::add_pointer_t<int>> ( _a[1] ) ) );
            break;

        case 5:
            _t->onNewSessionClicked();
            break;

        case 6:
            _t->onExitApplication();
            break;

        case 7:
            _t->onRbVolumeClicked();
            break;

        case 8:
            _t->onRbGavritmetricClicked();
            break;

        case 9:
            _t->onRbManualClicked();
            break;

        case 10:
            _t->onRbInterfaceClicked();
            break;

        case 11:
            _t->onAmbientTemperatureTextChanged();
            break;

        case 12:
            _t->onRelativeAirHumidityTextChanged();
            break;

        case 13:
            _t->onAthmosphericPressureTextChanged();
            break;
        ...
        case 20:
            _t->mousePressEvent ( ( *reinterpret_cast< std::add_pointer_t<QMouseEvent *>> ( _a[1] ) ) );
            break;
