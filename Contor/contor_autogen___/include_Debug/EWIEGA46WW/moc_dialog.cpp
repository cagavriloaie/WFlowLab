...
void Dialog::qt_static_metacall ( QObject *_o, QMetaObject::Call _c, int _id, void **_a ) {
    if ( _c == QMetaObject::InvokeMetaMethod ) {
        ...
        case 3:
            _t->onTypeMeterChanged();
            break;

        case 4:
            _t->onNumberOfWaterMetersChanged();
            break;

        case 5:
            _t->onSelectAllChanged();
            break;

        case 6:
            _t->onMeasurementTypeChanged();
            break;
        ...
        case 8:
            _t->onCbClicked ( ( *reinterpret_cast< std::add_pointer_t<bool>> ( _a[1] ) ) );
            break;
