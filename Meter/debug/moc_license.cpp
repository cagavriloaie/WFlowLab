...
static constexpr auto qt_meta_stringdata_CLASSLicenseENDCLASS = QtMocHelpers::stringData(
    "License",
    "showEvent",
    "",
    "QShowEvent*",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLicenseENDCLASS_t qt_meta_stringdata_CLASSLicenseENDCLASS = {
    {
...
void *License::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLicenseENDCLASS.stringdata0))
